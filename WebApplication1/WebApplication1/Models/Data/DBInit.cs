...
namespace AspNetBase.Models.Data
{
    public static class DBInit
    {
        ...
        private static List<RateModel> GetRateList()
        {
            ...
            foreach (ProductModel product in GetGoodsList())
            {
        ...
        private static List<ProductModel> GetGoodsList()
        {
            List<ProductModel> goodsList = new List<ProductModel>()
                {
                    new ProductModel("19.5\" Моноблок Lenovo Ideacentre AIO 330-20IGM [F0D70048RK]", 19999,
                    ...
                    new ProductModel("21.5\" Моноблок Acer Aspire C22-820 [DQ.BCKER.012]", 19999,
                    ...
                    new ProductModel( "27\" Моноблок Apple iMac Retina 5K [MRQY2RU/A]", 139999,
                    ...
                    new ProductModel("21.5\" Моноблок Acer Aspire C22-820 DQ.BCMER.001", 30999,
                    ...
                    new ProductModel("21.5\" Моноблок Apple iMac MMQA2RU/A [MMQA2RU/A]", 79999,
                    ...
                    new ProductModel("21.5\" Моноблок Lenovo 520-22AST [F0D6000JRK]", 26999,
                    ...
                    new ProductModel("19.5\" Моноблок HP 20-c409ur [4RK48EA]", 20999,
                    ...
                    new ProductModel("21.5\" Моноблок Lenovo IdeaCentre A340-22IGM [F0EA0020RK]", 26999,
                    ...
                    new ProductModel("23.8\" Моноблок Acer Aspire C24-860 [DQ.BACER.004]", 36899,
                    ...
                    new ProductModel("27\" Моноблок Dell Inspiron 7777 [7777-6566]", 116499,
            ...
            foreach (ProductModel product in goodsList)
            {
